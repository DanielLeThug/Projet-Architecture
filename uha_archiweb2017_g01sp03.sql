...
--
ALTER TABLE `cookies`
  ADD CONSTRAINT `cookies_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `utilisateurs` (`ID`) ON DELETE CASCADE;
...
ALTER TABLE `cours`
  ...
  ADD CONSTRAINT `ID_VACATAIRE_COURS` FOREIGN KEY (`ID_VACATAIRE`) REFERENCES `utilisateurs` (`ID`) ON DELETE CASCADE,
...
--
ALTER TABLE `documents_administratifs`
  ADD CONSTRAINT `ID_RESPONSABLE_ADMINISTRATIF_DOC` FOREIGN KEY (`ID_RESPONSABLE_ADMINISTRATIF`) REFERENCES `utilisateurs` (`ID`) ON DELETE CASCADE;
...
--
ALTER TABLE `virements`
  ADD CONSTRAINT `ID_RESPONSABLE_FINANCIER_VIREMENT` FOREIGN KEY (`ID_RESPONSABLE_FINANCIER`) REFERENCES `utilisateurs` (`ID`) ON DELETE CASCADE;
COMMIT;
