				...
				<li class="nav-item active">
					<a class="nav-link" href="upload"><i class="fa fa-file-text" aria-hidden="true"></i> Documents administratifs</a>
				</li>
			</ul>
		<!-- Bouton déconnexion -->
		<form class="form-inline my-2 my-lg-0">
		  <a href='logout' class="btn btn-danger my-2 my-sm-0" role="button"><i class="fa fa-sign-out" aria-hidden="true"></i> Se déconnecter</a>
		</form>
