...
class AddLesson_M extends Model {
	...
	{    
		...
		self::query('INSERT INTO cours VALUES (:ID_MATIERE, :ID_DATE, :ID_SALLE, :ID_VACATAIRE, NULL, :EFFECTUE, :ID_TYPE_DE_COURS, NULL)', array(':ID_MATIERE'=>$matiere, ':ID_DATE'=>$id_date[0][0], ':ID_SALLE'=>$salle,':ID_VACATAIRE'=>$professeur,':EFFECTUE'=>$effectue,':ID_TYPE_DE_COURS'=>$type_cours));
    }
